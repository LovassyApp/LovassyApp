...
export const getGetApiFeedItemsQueryKey = (params?: GetApiFeedItemsParams,) => {
    return [`/Api/FeedItems`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiFeedItemsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiFeedItems>>, TError, TData> & { queryKey: QueryKey }
}
