...
export const getGetApiLoloRequestsQueryKey = (params?: GetApiLoloRequestsParams,) => {
    return [`/Api/LoloRequests`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiLoloRequestsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiLoloRequests>>, TError, TData> & { queryKey: QueryKey }
}
...
export const usePostApiLoloRequests = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiLoloRequests>>, TError,{data: BodyType<ShopCreateLoloRequestRequestBody>;params?: PostApiLoloRequestsParams}, TContext>, }
        ...
        Awaited<ReturnType<typeof postApiLoloRequests>>,
        TError,
        {data: BodyType<ShopCreateLoloRequestRequestBody>;params?: PostApiLoloRequestsParams},
        TContext
      > => {
...
export const getGetApiLoloRequestsOwnQueryKey = (params?: GetApiLoloRequestsOwnParams,) => {
    return [`/Api/LoloRequests/Own`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiLoloRequestsOwnQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiLoloRequestsOwn>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getGetApiLoloRequestsIdQueryKey = (id: number,) => {
    return [`/Api/LoloRequests/${id}`] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiLoloRequestsIdQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiLoloRequestsId>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getPatchApiLoloRequestsIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchApiLoloRequestsIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Update a lolo request
 */
export const usePatchApiLoloRequestsId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiLoloRequestsId>>, TError,{id: number;data: BodyType<ShopUpdateLoloRequestRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof patchApiLoloRequestsId>>,
        TError,
        {id: number;data: BodyType<ShopUpdateLoloRequestRequestBody>},
        TContext
      > => {
...
export const getDeleteApiLoloRequestsIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiLoloRequestsIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Delete a lolo request
 */
export const useDeleteApiLoloRequestsId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiLoloRequestsId>>, TError,{id: number}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiLoloRequestsId>>,
        TError,
        {id: number},
        TContext
      > => {
...
export const getPostApiLoloRequestsOverruleIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiLoloRequestsOverruleIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Overrule a lolo request
 */
export const usePostApiLoloRequestsOverruleId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiLoloRequestsOverruleId>>, TError,{id: number;data: BodyType<ShopOverruleLoloRequestRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof postApiLoloRequestsOverruleId>>,
        TError,
        {id: number;data: BodyType<ShopOverruleLoloRequestRequestBody>},
        TContext
      > => {
