...
export const getGetApiOwnedItemsQueryKey = (params?: GetApiOwnedItemsParams,) => {
    return [`/Api/OwnedItems`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiOwnedItemsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiOwnedItems>>, TError, TData> & { queryKey: QueryKey }
}
...
export const usePostApiOwnedItems = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiOwnedItems>>, TError,{data: BodyType<ShopCreateOwnedItemRequestBody>}, TContext>, }
        ...
        Awaited<ReturnType<typeof postApiOwnedItems>>,
        TError,
        {data: BodyType<ShopCreateOwnedItemRequestBody>},
        TContext
      > => {
...
export const getGetApiOwnedItemsOwnQueryKey = (params?: GetApiOwnedItemsOwnParams,) => {
    return [`/Api/OwnedItems/Own`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiOwnedItemsOwnQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiOwnedItemsOwn>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getGetApiOwnedItemsIdQueryKey = (id: number,) => {
    return [`/Api/OwnedItems/${id}`] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiOwnedItemsIdQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiOwnedItemsId>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getPatchApiOwnedItemsIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchApiOwnedItemsIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Update an owned item
 */
export const usePatchApiOwnedItemsId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiOwnedItemsId>>, TError,{id: number;data: BodyType<ShopUpdateOwnedItemRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof patchApiOwnedItemsId>>,
        TError,
        {id: number;data: BodyType<ShopUpdateOwnedItemRequestBody>},
        TContext
      > => {
...
export const getDeleteApiOwnedItemsIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiOwnedItemsIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Delete an owned item
 */
export const useDeleteApiOwnedItemsId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiOwnedItemsId>>, TError,{id: number}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiOwnedItemsId>>,
        TError,
        {id: number},
        TContext
      > => {
...
export const getPostApiOwnedItemsIdUseMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiOwnedItemsIdUseMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Use an owned item
 */
export const usePostApiOwnedItemsIdUse = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiOwnedItemsIdUse>>, TError,{id: number;data: BodyType<ShopUseOwnedItemRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof postApiOwnedItemsIdUse>>,
        TError,
        {id: number;data: BodyType<ShopUseOwnedItemRequestBody>},
        TContext
      > => {
