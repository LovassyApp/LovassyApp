...
export const getGetApiImageVotingsQueryKey = (params?: GetApiImageVotingsParams,) => {
    return [`/Api/ImageVotings`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotings>>, TError, TData> & { queryKey: QueryKey }
}
...
export const usePostApiImageVotings = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiImageVotings>>, TError,{data: BodyType<ImageVotingsCreateImageVotingRequestBody>}, TContext>, }
        ...
        Awaited<ReturnType<typeof postApiImageVotings>>,
        TError,
        {data: BodyType<ImageVotingsCreateImageVotingRequestBody>},
        TContext
      > => {
...
export const getGetApiImageVotingsIdQueryKey = (id: number,) => {
    return [`/Api/ImageVotings/${id}`] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingsIdQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingsId>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getPatchApiImageVotingsIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchApiImageVotingsIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Update an image voting
 */
export const usePatchApiImageVotingsId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiImageVotingsId>>, TError,{id: number;data: BodyType<ImageVotingsUpdateImageVotingRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof patchApiImageVotingsId>>,
        TError,
        {id: number;data: BodyType<ImageVotingsUpdateImageVotingRequestBody>},
        TContext
      > => {
...
export const getDeleteApiImageVotingsIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiImageVotingsIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Delete an image voting
 */
export const useDeleteApiImageVotingsId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiImageVotingsId>>, TError,{id: number}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiImageVotingsId>>,
        TError,
        {id: number},
        TContext
      > => {
...
export const getGetApiImageVotingsIdResultsQueryKey = (id: number,) => {
    return [`/Api/ImageVotings/${id}/Results`] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingsIdResultsQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingsIdResults>>, TError, TData> & { queryKey: QueryKey }
}
