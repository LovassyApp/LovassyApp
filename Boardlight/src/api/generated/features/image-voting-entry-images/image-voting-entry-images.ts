...
export const getGetApiImageVotingEntryImagesQueryKey = (params?: GetApiImageVotingEntryImagesParams,) => {
    return [`/Api/ImageVotingEntryImages`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingEntryImagesQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingEntryImages>>, TError, TData> & { queryKey: QueryKey }
}
...
export const usePostApiImageVotingEntryImages = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiImageVotingEntryImages>>, TError,{data: BodyType<PostApiImageVotingEntryImagesBody>}, TContext>, }
        ...
        Awaited<ReturnType<typeof postApiImageVotingEntryImages>>,
        TError,
        {data: BodyType<PostApiImageVotingEntryImagesBody>},
        TContext
      > => {
...
export const getDeleteApiImageVotingEntryImagesIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiImageVotingEntryImagesIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Delete an image meant for an image voting entry
 */
export const useDeleteApiImageVotingEntryImagesId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiImageVotingEntryImagesId>>, TError,{id: number}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiImageVotingEntryImagesId>>,
        TError,
        {id: number},
        TContext
      > => {
