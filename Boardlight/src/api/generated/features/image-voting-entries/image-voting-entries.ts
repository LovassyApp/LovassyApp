...
export const getGetApiImageVotingEntriesQueryKey = (params?: GetApiImageVotingEntriesParams,) => {
    return [`/Api/ImageVotingEntries`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingEntriesQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingEntries>>, TError, TData> & { queryKey: QueryKey }
}
...
export const usePostApiImageVotingEntries = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiImageVotingEntries>>, TError,{data: BodyType<ImageVotingsCreateImageVotingEntryRequestBody>}, TContext>, }
        ...
        Awaited<ReturnType<typeof postApiImageVotingEntries>>,
        TError,
        {data: BodyType<ImageVotingsCreateImageVotingEntryRequestBody>},
        TContext
      > => {
...
export const getGetApiImageVotingEntriesIdQueryKey = (id: number,) => {
    return [`/Api/ImageVotingEntries/${id}`] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingEntriesIdQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingEntriesId>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getPatchApiImageVotingEntriesIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchApiImageVotingEntriesIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Update an image voting entry
 */
export const usePatchApiImageVotingEntriesId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiImageVotingEntriesId>>, TError,{id: number;data: BodyType<ImageVotingsUpdateImageVotingEntryRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof patchApiImageVotingEntriesId>>,
        TError,
        {id: number;data: BodyType<ImageVotingsUpdateImageVotingEntryRequestBody>},
        TContext
      > => {
...
export const getDeleteApiImageVotingEntriesIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiImageVotingEntriesIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Delete an image voting entry
 */
export const useDeleteApiImageVotingEntriesId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiImageVotingEntriesId>>, TError,{id: number}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiImageVotingEntriesId>>,
        TError,
        {id: number},
        TContext
      > => {
...
export const getPostApiImageVotingEntriesIdChoiceMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiImageVotingEntriesIdChoiceMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Choose an image voting entry (SingleChoice image votings only)
 */
export const usePostApiImageVotingEntriesIdChoice = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiImageVotingEntriesIdChoice>>, TError,{id: number;data: BodyType<ImageVotingsChooseImageVotingEntryRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof postApiImageVotingEntriesIdChoice>>,
        TError,
        {id: number;data: BodyType<ImageVotingsChooseImageVotingEntryRequestBody>},
        TContext
      > => {
...
export const getDeleteApiImageVotingEntriesIdChoiceMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiImageVotingEntriesIdChoiceMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Unchoose an image voting entry (SingleChoice image votings only)
 */
export const useDeleteApiImageVotingEntriesIdChoice = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiImageVotingEntriesIdChoice>>, TError,{id: number;data: BodyType<ImageVotingsUnchooseImageVotingEntryRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiImageVotingEntriesIdChoice>>,
        TError,
        {id: number;data: BodyType<ImageVotingsUnchooseImageVotingEntryRequestBody>},
        TContext
      > => {
...
export const getPostApiImageVotingEntriesIdIncrementMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiImageVotingEntriesIdIncrementMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Increment an image voting entry (Increment image votings only)
 */
export const usePostApiImageVotingEntriesIdIncrement = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiImageVotingEntriesIdIncrement>>, TError,{id: number;data: BodyType<ImageVotingsCreateImageVotingEntryIncrementRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof postApiImageVotingEntriesIdIncrement>>,
        TError,
        {id: number;data: BodyType<ImageVotingsCreateImageVotingEntryIncrementRequestBody>},
        TContext
      > => {
...
export const getDeleteApiImageVotingEntriesIdIncrementMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiImageVotingEntriesIdIncrementMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Delete an image voting entry increment (Increment image votings only)
 */
export const useDeleteApiImageVotingEntriesIdIncrement = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiImageVotingEntriesIdIncrement>>, TError,{id: number;data: BodyType<ImageVotingsDeleteImageVotingEntryIncrementRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiImageVotingEntriesIdIncrement>>,
        TError,
        {id: number;data: BodyType<ImageVotingsDeleteImageVotingEntryIncrementRequestBody>},
        TContext
      > => {
