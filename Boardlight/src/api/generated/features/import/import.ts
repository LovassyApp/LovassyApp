...
export const getGetApiImportUsersQueryKey = (params?: GetApiImportUsersParams,) => {
    return [`/Api/Import/Users`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImportUsersQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImportUsers>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getPostApiImportGradesUserIdMutationOptions = <TError = ErrorType<void | ProblemDetails>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiImportGradesUserIdMutationError = ErrorType<void | ProblemDetails>

    /**
 * @summary Import grades for a user
 */
export const usePostApiImportGradesUserId = <TError = ErrorType<void | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiImportGradesUserId>>, TError,{userId: string;data: BodyType<ImportImportGradesRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof postApiImportGradesUserId>>,
        TError,
        {userId: string;data: BodyType<ImportImportGradesRequestBody>},
        TContext
      > => {
...
export const getPutApiImportResetKeyPasswordMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PutApiImportResetKeyPasswordMutationError = ErrorType<void>

    /**
 * @summary Set the reset key password
 */
export const usePutApiImportResetKeyPassword = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putApiImportResetKeyPassword>>, TError,{data: BodyType<ImportUpdateResetKeyPasswordRequestBody>}, TContext>, }
): UseMutationResult<
        Awaited<ReturnType<typeof putApiImportResetKeyPassword>>,
        TError,
        {data: BodyType<ImportUpdateResetKeyPasswordRequestBody>},
        TContext
      > => {
