...
export const getGetApiImageVotingChoicesQueryKey = (params?: GetApiImageVotingChoicesParams,) => {
    return [`/Api/ImageVotingChoices`, ...(params ? [params]: [])] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingChoicesQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingChoices>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getGetApiImageVotingChoicesIdQueryKey = (id: number,) => {
    return [`/Api/ImageVotingChoices/${id}`] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiImageVotingChoicesIdQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiImageVotingChoicesId>>, TError, TData> & { queryKey: QueryKey }
}
