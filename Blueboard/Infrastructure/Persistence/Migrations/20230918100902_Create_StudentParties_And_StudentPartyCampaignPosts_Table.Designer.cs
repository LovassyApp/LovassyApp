...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blueboard.Infrastructure.Persistence.Entities.StudentParty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<List<StudentPartyMember>>("Members")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("ProgramPlanUrl")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("StudentParties");
                });

            modelBuilder.Entity("Blueboard.Infrastructure.Persistence.Entities.StudentPartyCampaignPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentPartyId");

                    b.ToTable("StudentPartyCampaignPosts");
                });
            ...
            modelBuilder.Entity("Blueboard.Infrastructure.Persistence.Entities.StudentPartyCampaignPost", b =>
                {
                    b.HasOne("Blueboard.Infrastructure.Persistence.Entities.StudentParty", "StudentParty")
                        .WithMany("StudentPartyCampaignPosts")
                        .HasForeignKey("StudentPartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StudentParty");
                });
            ...
            modelBuilder.Entity("Blueboard.Infrastructure.Persistence.Entities.StudentParty", b =>
                {
                    b.Navigation("StudentPartyCampaignPosts");
                });
