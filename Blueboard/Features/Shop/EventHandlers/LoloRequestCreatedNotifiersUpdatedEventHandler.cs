...
public class
    LoloRequestCreatedNotifiersUpdatedEventHandler(IHubContext<NotificationsHub, INotificationsClient> notificationsHub)
    : INotificationHandler<LoloRequestCreatedNotifiersUpdatedEvent>
{
